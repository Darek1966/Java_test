...
public class J_Screenshots {
    ...
    public void takeAScreenshot() throws IOException, InterruptedException {
        ...
        FileUtils.copyFile(scrFile, new File("E:\\Py_JAVA\\Java_SELENIU\\program.automatycy.selenium.poczatkujacy\\program.automatycy.selenium.poczatkujacy\\screenshots\\screenshot.jpg"));
